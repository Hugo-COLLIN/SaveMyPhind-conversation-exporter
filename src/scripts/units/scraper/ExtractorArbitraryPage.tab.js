...
import {formatLink, setFileHeader, turndownConverter} from "../formatter/formatMarkdown.all";
...
export default class ExtractorArbitraryPage extends Extractor {
  ...
  applyExtractorRules() {
    ...
    turndownConverter.addRule('reformatLinksContainingTags', rulesTab.reformatLinksContainingTags);
